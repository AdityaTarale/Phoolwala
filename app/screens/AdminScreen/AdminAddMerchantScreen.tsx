...
//     `<Stack.Screen name="AdminMerchant" component={AdminAddMerchantScreen} />`
// Hint: Look for the 🔥!

// REMOVE ME! ⬇️ This TS ignore will not be necessary after you've added the correct navigator param type
// @ts-ignore
export const AdminAddMerchantScreen: FC<
  StackScreenProps<AdminNavigatorParamList, "AdminAddMerchant">
> = observer(function AdminAddMerchantScreen(__props) {
  useHeader({
    title: "",
    leftIcon: "back",
    onLeftPress: goBack,
